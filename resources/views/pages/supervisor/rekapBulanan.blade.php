                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach ($rekapData as $rekapData)
                                <tr>
                                    <td><a href='{{url("/rekapData/{$rekapData->tahun_masuk}/{$rekapData->bulan_masuk}/{$rekapData->hari_masuk}")}}'>{{ $rekapData->tanggal_pemasukan }}</a></td>
                                    <td><a href='{{url("/rekapData/{$rekapData->tahun_keluar}/{$rekapData->bulan_keluar}/{$rekapData->hari_keluar}")}}'>{{ $rekapData->tanggal_pengeluaran }}</a></td>
